...
/**
 * Created by Namtoey on 6/12/2558.
 */
public class MyAdapter extends BaseAdapter{

    //Explicit คือประกาศตัวแปร
    private Context objContext;
    private String[] titleStrings, datailStrings;
    private int[] iconInts;

    public MyAdapter(Context objContext, String[] titleStrings, String[] datailStrings, int[] iconInts) {
        this.objContext = objContext;
        this.titleStrings = titleStrings;
        this.datailStrings = datailStrings;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        detailTextView.setText(datailStrings[position]);
        //Setup Image
